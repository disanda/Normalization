...
#train_and_test(use_larger_weights=False, learning_rate=0.01, activation_fn=tf.nn.sigmoid, training_batches=3000, batches_per_validate_data=50)


#learning_rate=2
#train_and_test(use_larger_weights=False, learning_rate=2, activation_fn=tf.nn.relu)

#train_and_test(use_larger_weights=False, learning_rate=2, activation_fn=tf.nn.relu, training_batches=3000, batches_per_validate_data=50)
